...
Download the latest builds from our [build server][Builds]. [![Build Status](http://build.spout.org/job/DropletSeat/badge/icon)][Builds]

## Compiling the Source
DropletSeat uses Maven to handle its dependencies.
...
Change the `config.yml` located under `plugins/DropletSeat` as needed.
...
[Source]: https://github.com/Droplets/DropletSeat
